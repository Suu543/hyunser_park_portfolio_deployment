...
import { removeGridImage, readGridImages } from "../../actions/grid";
...
const ImageTitleWrapper = styled.section`
  display: flex;
  width: 80%;
  margin: auto;
  margin-top: 1%;
...
const ReadGridImages = () => {
  ...
  const deleteImage = async (id) => {
    try {
      const deletedImage = await removeGridImage(id, token);
  ...
  return (
    <Layout>
      <ImageContainer>
        ...
        <ImageCreateFeature>
          <ImageCreateFeatureLink to="/admin/grid/create">
            <button>Create Grid Image</button>
            ...
            images.map((img, i) => (
              <React.Fragment>
                ...
                <ImageFeatureWrapper>
                  ...
                  <Link to={`/admin/grid/update/${img._id}`}>
